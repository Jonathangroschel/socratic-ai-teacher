      ...
      >
        ...
        <div className="flex flex-row gap-2 items-start">
          <PromptInputTextarea
            ...
            className="text-base grow resize-none p-3 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] bg-transparent !border-0 !border-none outline-none ring-0 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:outline-none placeholder:text-muted-foreground"
            rows={1}
            autoFocus
          />{' '}
        </div>
